...
public class Sub1Chap4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Sub1Chap4.this, "Loading PDF from public URL", Toast.LENGTH_SHORT).show();
    }
    ...
    private class RetrievePdfStream extends AsyncTask<String, Void, InputStream> {
        ...
        protected void onPostExecute(InputStream inputStream) {
            if (inputStream != null) {
                ...
                Toast.makeText(Sub1Chap4.this, "Error loading PDF", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
