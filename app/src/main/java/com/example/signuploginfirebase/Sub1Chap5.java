...
public class Sub1Chap5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Sub1Chap5.this, "Loading PDF from public URL", Toast.LENGTH_SHORT).show();
    }
    ...
    private class RetrievePdfStream extends AsyncTask<String, Void, InputStream> {
        ...
        protected void onPostExecute(InputStream inputStream) {
            if (inputStream != null) {
                ...
                Toast.makeText(Sub1Chap5.this, "Error loading PDF", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
