...
public class Sub1Chap1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub1_chap1);
        ...
        String publicPdfUrl = "https://firebasestorage.googleapis.com/v0/b/e-book-1149f.firebasestorage.app/o/Spoken%20English%20book%2FCh-1_Mass%26%20Spoken_compressed.pdf?alt=media&token=e1db6147-7497-46be-b8e2-7ecadaf79e89";
        new RetrievePdfStream().execute(publicPdfUrl);
        Toast.makeText(Sub1Chap1.this, "Loading PDF from public URL", Toast.LENGTH_SHORT).show();
    }
    ...
    private class RetrievePdfStream extends AsyncTask<String, Void, InputStream> {
        ...
        protected void onPostExecute(InputStream inputStream) {
            if (inputStream != null) {
                ...
                Toast.makeText(Sub1Chap1.this, "Error loading PDF", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
